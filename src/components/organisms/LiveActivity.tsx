...
export async function LiveActivity() {
  ...
  return (
    <section className="py-28 w-full" style={{ background: "var(--background)" }}>
        ...
        <div className="mb-12">
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            ...
            <a
              ...
              className="hover:text-foreground hover:border-muted-foreground"
            >
              ...
              >
                ...
                >
                  ...
                  <CardHeader className="pb-2 pt-5 px-5">
                    <CardTitle className="text-sm font-medium text-foreground/80 group-hover:text-foreground transition-colors tracking-wide leading-snug">
                      {repo.name}
                    </CardTitle>
                    <CardDescription className="text-muted-foreground/60 text-xs leading-relaxed line-clamp-2 mt-1.5">
                      {repo.description || "No description provided."}
                    </CardDescription>
                  </CardHeader>

                  <CardContent className="flex-grow flex items-end pt-0 px-5 pb-4">
                    <div className="flex items-center gap-4 text-xs text-muted-foreground/40 w-full pt-3 border-t border-border">
                      {repo.language && (
                        <div className="flex items-center gap-1.5">
                          ...
                          />
                          <span className="text-muted-foreground/70">{repo.language}</span>
                        </div>
                      )}
